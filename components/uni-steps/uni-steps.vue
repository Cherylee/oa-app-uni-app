		...
		<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
			<view :class="[direction==='column'?'uni-steps__column-text-container':'uni-steps__row-text-container']">
				<view v-for="(item,index) in options" :key="index" :class="[direction==='column'?'uni-steps__column-text':'uni-steps__row-text']">
					<text :class="[direction==='column'?'uni-steps__column-title':'uni-steps__row-title']">{{item.actName}}</text>
					<text :class="[direction==='column'?'uni-steps__column-desc':'uni-steps__row-desc']">{{item.message}}</text>
					<text :class="[direction==='column'?'uni-steps__column-stime':'uni-steps__row-desc']">提交时间：{{item.startTime}}</text>
					<text :class="[direction==='column'?'uni-steps__column-etime':'uni-steps__row-desc']">审批时间：{{item.endTime}}</text>
				</view>
			</view>
...
<style scoped>
	...
	.uni-steps__column-stime{
		font-size: 24rpx;
		text-align: left;
		line-height: 18px;
		color: #999999;
	}
	.uni-steps__column-etime{
		font-size: 24rpx;
		text-align: left;
		line-height: 18px;
		color: #999999;
